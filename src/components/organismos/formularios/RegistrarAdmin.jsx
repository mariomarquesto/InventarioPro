...
export function RegistrarAdmin({ state, setState, setStateInicio }) { // setStateInicio is passed as a prop
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      ...
      if (dt) {
        ...
        // Fix: Use setStateInicio, and it likely takes the inverse of 'state'
        setStateInicio(!state);
      }
    },
  });
